...
const km: typeof en = {
    ...
    basicResume: {
        ...
        editor: {
            ...
            editTab: "វាយបញ្ចូល",
            voiceTab: "ឆ្លើយដោយសំឡេង",
            voice: {
                title: "ឆ្លើយដោយសំឡេង",
                intro: "ខ្ញុំនឹងសួរអ្នកប្រហែល ១៥ សំណួរខ្លីៗ។ អ្នកអាចឆ្លើយដោយសំឡេង ឬវាយបញ្ចូល តាមដែលងាយស្រួល។ សំណួរណាដែលអ្នកមិនចង់ឆ្លើយ អាចរំលងបាន។",
                startEn: "ចាប់ផ្តើមជាភាសាអង់គ្លេស",
                startKm: "ចាប់ផ្តើមជាភាសាខ្មែរ",
                cost: "អស់ ៥ កាក់សម្រាប់ការសម្ភាសន៍ទាំងមូល ទោះបីអ្នកឆ្លើយប៉ុន្មានសំណួរក៏ដោយ។",
                step: "សំណួរទី {n} ក្នុងចំណោម {total}",
                finished: "រួចរាល់ហើយ",
                finishedNote: "ប្រវត្តិរូបរបស់អ្នកនៅខាងស្តាំ។ សូមពិនិត្យមើល ហើយកែតម្រូវអ្វីដែលខ្ញុំស្តាប់មិនច្បាស់ — អ្នកអាចកែគ្រប់ចន្លោះដោយវាយបញ្ចូល។",
                close: "បិទ",
                ...
                statusSpeaking: "កំពុងនិយាយ...",
                followUpNote: "សូមសួរម្តងទៀតតាមរបៀបផ្សេង",
                optionalNote: "សំណួរនេះអាចរំលងបាន។",
                transcriptLabel: "ខ្ញុំបានឮថា",
                typedLabel: "ឬវាយបញ្ចូលចម្លើយរបស់អ្នក",
                typedPlaceholder: "វាយបញ្ចូលនៅទីនេះជំនួសវិញ",
                send: "ផ្ញើ",
                skip: "រំលងសំណួរនេះ",
                textOnlyNote: "ការនិយាយមិនអាចប្រើបានឥឡូវនេះទេ សូមវាយបញ្ចូលចម្លើយខាងក្រោម។ អ្វីៗផ្សេងទៀតដំណើរការដូចដើម។",
                problems: {
                    "insufficient-coins": "អ្នកមិនមានកាក់គ្រប់គ្រាន់សម្រាប់ការសម្ភាសន៍ទេ។ សូមបញ្ចូលកាក់បន្ថែម រួចព្យាយាមម្តងទៀត។",
                    "session-expired": "ការសម្ភាសន៍នេះអស់ពេលហើយ។ សូមចាប់ផ្តើមថ្មី — អ្វីដែលអ្នកបានឆ្លើយរួចមិនបាត់ទេ។",
                    "session-exhausted": "យើងបានប្រើវេនទាំងអស់សម្រាប់ការសម្ភាសន៍នេះហើយ។ ប្រវត្តិរូបរបស់អ្នកត្រូវបានរក្សាទុកជាមួយអ្វីៗដែលអ្នកបានឆ្លើយ។",
                    network: "មិនអាចតភ្ជាប់ទៅម៉ាស៊ីនមេបានទេ។ សូមពិនិត្យអ៊ីនធឺណិត រួចព្យាយាមឆ្លើយម្តងទៀត។",
                    "no-speech": "ខ្ញុំមិនបានឮអ្វីទេ។ សូមពិនិត្យថាមីក្រូហ្វូនមិនត្រូវបានបិទសំឡេង ឬវាយបញ្ចូលចម្លើយជំនួសវិញ។",
                    degraded: "ខ្ញុំបានរក្សាទុកចម្លើយរបស់អ្នកដូចដែលអ្នកបានឆ្លើយ ប៉ុន្តែមិនអាចរៀបចំវាឥឡូវនេះទេ។ សូមពិនិត្យផ្នែកនោះនៃប្រវត្តិរូបមុននឹងផ្ញើ។",
                    "start-failed": "មិនអាចចាប់ផ្តើមការសម្ភាសន៍បានទេ។ សូមព្យាយាមម្តងទៀត។"
                },
                micProblems: {
                    unsupported: "កម្មវិធីរុករកនេះមិនអាចថតសំឡេងបានទេ។ អ្នកនៅតែអាចវាយបញ្ចូលគ្រប់ចម្លើយបាន។",
                    "permission-denied": "ការចូលប្រើមីក្រូហ្វូនត្រូវបានបិទ។ សូមអនុញ្ញាតក្នុងការកំណត់កម្មវិធីរុករក ឬវាយបញ្ចូលចម្លើយជំនួសវិញ។",
                    "permission-dismissed": "សំណើសុំមីក្រូហ្វូនត្រូវបានបិទចោល។ សូមចុចប៊ូតុងម្តងទៀតដើម្បីអនុញ្ញាត ឬវាយបញ្ចូលចម្លើយ។",
                    "no-microphone": "រកមីក្រូហ្វូនមិនឃើញទេ។ សូមភ្ជាប់មួយ ឬវាយបញ្ចូលចម្លើយជំនួសវិញ។",
                    "capture-failed": "មីក្រូហ្វូនឈប់ដំណើរការ។ សូមព្យាយាមម្តងទៀត ឬវាយបញ្ចូលចម្លើយ។"
                }
            },
            identity: "អំពីអ្នក",
            fullName: "ឈ្មោះពេញ",
    ...
    basicInterview: {
        questions: {
            fullName: {
                prompt: "ចាប់ផ្តើមដោយឈ្មោះរបស់អ្នកសិន។ តើអ្នកឈ្មោះអ្វី?",
                followUp: "សុំទោស ខ្ញុំមិនបានឮច្បាស់ទេ។ សូមប្រាប់ឈ្មោះពេញរបស់អ្នកម្តងទៀត យឺតៗ។"
            },
            positionSought: {
                prompt: "តើអ្នកកំពុងដាក់ពាក្យសុំធ្វើការតំណែងអ្វី?",
                followUp: "តើអ្នកចង់ធ្វើការប្រភេទណា? ឧទាហរណ៍ អ្នករត់តុ អ្នកយាម ឬកម្មកររោងចក្រ។"
            },
            phone: {
                prompt: "តើលេខទូរស័ព្ទរបស់អ្នកគឺជាលេខអ្វី?",
                followUp: "សូមប្រាប់លេខទូរស័ព្ទម្តងទៀត ម្តងមួយតួលេខ។"
            },
            address: {
                prompt: "តើអ្នករស់នៅឯណា? អ្នកអាចប្រាប់ភូមិ ឃុំ ស្រុក និងខេត្តបាន។",
                followUp: "តើអ្នករស់នៅខេត្តណា ហើយស្រុកណា?"
            },
            dateOfBirth: {
                prompt: "តើអ្នកកើតនៅថ្ងៃខែឆ្នាំណា?",
                followUp: "តើអ្នកកើតនៅឆ្នាំណា? បើអ្នកចាំថ្ងៃ និងខែ សូមប្រាប់ផងដែរ។"
            },
            gender: {
                prompt: "តើអ្នកជាភេទអ្វី? បើអ្នកមិនចង់ឆ្លើយ អាចរំលងបាន។"
            },
            nationality: {
                prompt: "តើអ្នកមានសញ្ជាតិអ្វី?"
            },
            placeOfBirth: {
                prompt: "តើអ្នកកើតនៅទីកន្លែងណា?"
            },
            maritalStatus: {
                prompt: "តើអ្នកនៅលីវ ឬរៀបការហើយ? បើអ្នកមិនចង់ឆ្លើយ អាចរំលងបាន។"
            },
            health: {
                prompt: "តើសុខភាពទូទៅរបស់អ្នកយ៉ាងណាដែរ? បើអ្នកមិនចង់ឆ្លើយ អាចរំលងបាន។"
            },
            education: {
                prompt: "ឥឡូវនេះ យើងនិយាយអំពីការសិក្សា។ សូមប្រាប់ខ្ញុំអំពីសាលា ឬវគ្គសិក្សានីមួយៗ ព្រមទាំងឆ្នាំផង។ សូមនិយាយតាមសម្រួល។",
                followUp: "តើសាលា ឬវគ្គសិក្សាចុងក្រោយដែលអ្នកបានបញ្ចប់គឺជាអ្វី ហើយប្រហែលនៅឆ្នាំណា?"
            },
            experience: {
                prompt: "តើអ្នកធ្លាប់ធ្វើការពីមុនទេ? សូមប្រាប់ការងារនីមួយៗ ព្រមទាំងឆ្នាំផង។"
            },
            languages: {
                prompt: "តើអ្នកចេះភាសាអ្វីខ្លះ? សម្រាប់ភាសានីមួយៗ សូមប្រាប់ថាអ្នកអាចនិយាយ ស្តាប់ អាន ឬបកប្រែបាន។"
            },
            interests: {
                prompt: "តើអ្នកចូលចិត្តធ្វើអ្វីនៅពេលទំនេរ?"
            },
            personalStatement: {
                prompt: "សំណួរចុងក្រោយ។ តើអ្នកនឹងពណ៌នាខ្លួនឯងជាបុគ្គលិកម្នាក់យ៉ាងដូចម្តេច?"
            }
        }
    },
    language: {
